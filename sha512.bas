Function SHA512$128 (I$)
    ...
    If k(0) = 0 Then
        ...
        For I = 0 To 79
            Read k(I)
            Print Integer64ToBits(k(I)); " "; Integer64ToHex(k(I))
        Next I
    End If
    ...
    Padding$ = Mid$(I$, _SHL(Message_Parts, 7)) + Padding$
    Parts = Message_Parts + _SHR(Len(Padding$), 7)
    For Part = 1 To Parts
        If Part > Message_Parts Then
            CurrentBlock$ = Mid$(Padding$, _SHL(Part - Message_Parts, 7) - 127, 128)
        Else
            CurrentBlock$ = Mid$(I$, _SHL(Part, 7) - 127, 128)
        End If
        For I = 0 To 15
    ...
    Data &H428a2f98d728ae22,&H7137449123ef65cd,&Hb5c0fbcfec4d3b2f,&He9b5dba58189dbbc,&H3956c25bf348b538,&H59f111f1b605d019,&H923f82a4af194f9b,&Hab1c5ed5da6d8118,&Hd807aa98a3030242,&H12835b0145706fbe,&H243185be4ee4b28c,&H550c7dc3d5ffb4e2,&H72be5d74f27b896f,&H80deb1fe3b1696b1,&H9bdc06a725c71235,&Hc19bf174cf692694,&He49b69c19ef14ad2,&Hefbe4786384f25e3,&H0fc19dc68b8cd5b5,&H240ca1cc77ac9c65,&H2de92c6f592b0275,&H4a7484aa6ea6e483,&H5cb0a9dcbd41fbd4,&H76f988da831153b5,&H983e5152ee66dfab,&Ha831c66d2db43210,&Hb00327c898fb213f,&Hbf597fc7beef0ee4,&Hc6e00bf33da88fc2,&Hd5a79147930aa725,&H06ca6351e003826f,&H142929670a0e6e70,&H27b70a8546d22ffc,&H2e1b21385c26c926,&H4d2c6dfc5ac42aed,&H53380d139d95b3df,&H650a73548baf63de,&H766a0abb3c77b2a8,&H81c2c92e47edaee6,&H92722c851482353b,&Ha2bfe8a14cf10364,&Ha81a664bbc423001,&Hc24b8b70d0f89791,&Hc76c51a30654be30,&Hd192e819d6ef5218,&Hd69906245565a910,&Hf40e35855771202a,&H106aa07032bbd1b8,&H19a4c116b8d2d0c8,&H1e376c085141ab53,&H2748774cdf8eeb99,&H34b0bcb5e19b48a8,&H391c0cb3c5c95a63,&H4ed8aa4ae3418acb,&H5b9cca4f7763e373,&H682e6ff3d6b2b8a3,&H748f82ee5defb2fc,&H78a5636f43172f60,&H84c87814a1f0ab72,&H8cc702081a6439ec,&H90befffa23631e28,&Ha4506cebde82bde9,&Hbef9a3f7b2c67915,&Hc67178f2e372532b,&Hca273eceea26619c,&Hd186b8c721c0c207,&Heada7dd6cde0eb1e,&Hf57d4f7fee6ed178,&H06f067aa72176fba,&H0a637dc5a2c898a6,&H113f9804bef90dae,&H1b710b35131c471b,&H28db77f523047d84,&H32caab7b40c72493,&H3c9ebe0a15c9bebc,&H431d67c49c100d4c,&H4cc5d4becb3e42b6,&H597f299cfc657e2a,&H5fcb6fab3ad6faec,&H6c44198c4a475817
End Function
